...
function copy(yum){
    const magicalUnicorn = yum.slice();
...
function addFlavor(yum){
    yum.unshift('Rainbow Sherbert');{
        return yum.length
    }
...
function removeFlavorByName(yum){
